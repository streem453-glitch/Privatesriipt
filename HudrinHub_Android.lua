...
local Themes = {
    Sakura = {
        Background = Color3.fromRGB(111, 204, 211),
        Background2 = Color3.fromRGB(190, 235, 235),
        Panel = Color3.fromRGB(255, 226, 235),
        PanelDark = Color3.fromRGB(76, 165, 177),
        Accent = Color3.fromRGB(255, 126, 170),
        Accent2 = Color3.fromRGB(104, 211, 218),
        Text = Color3.fromRGB(255, 255, 255),
        TextDark = Color3.fromRGB(77, 112, 120),
        Stroke = Color3.fromRGB(255, 192, 211),
    },

    Ocean = {
        Background = Color3.fromRGB(72, 177, 194),
        Background2 = Color3.fromRGB(156, 224, 230),
        Panel = Color3.fromRGB(224, 248, 250),
        PanelDark = Color3.fromRGB(54, 140, 155),
        Accent = Color3.fromRGB(255, 143, 188),
        Accent2 = Color3.fromRGB(91, 216, 226),
        Text = Color3.fromRGB(255, 255, 255),
        TextDark = Color3.fromRGB(50, 104, 114),
        Stroke = Color3.fromRGB(154, 232, 235),
    },

    Pink = {
        Background = Color3.fromRGB(232, 173, 202),
        Background2 = Color3.fromRGB(255, 217, 231),
        Panel = Color3.fromRGB(255, 235, 242),
        PanelDark = Color3.fromRGB(191, 116, 153),
        Accent = Color3.fromRGB(226, 89, 147),
        Accent2 = Color3.fromRGB(107, 204, 211),
        Text = Color3.fromRGB(255, 255, 255),
        TextDark = Color3.fromRGB(113, 70, 91),
        Stroke = Color3.fromRGB(241, 153, 188),
    },
}
...
Sidebar.Size = UDim2.fromOffset(165, 0)
...
PageContainer.Position = UDim2.fromOffset(178, 0)
PageContainer.Size = UDim2.new(1, -178, 1, 0)
...
do
    ...
    Section(
        page,
        "Training ESP",
        "Только NPC с тегом HudrinTestTarget.",
        76
    )
...
do
    ...
    local themeNames = {"Sakura", "Ocean", "Pink"}

    for index, themeName in ipairs(themeNames) do
        local button = MakeButton(
            theme,
            themeName,
            UDim2.fromOffset(105, 40),
            UDim2.fromOffset(15 + (index - 1) * 115, 55)
        )
...
HBS.Name = "HBS"
HBS.AnchorPoint = Vector2.new(1, 1)
HBS.Position = UDim2.new(1, -20, 1, -115)
HBS.Size = UDim2.fromOffset(64, 64)
...
local function UpdateResponsiveSize()
    ...
    if viewport.X < 700 then
        ...
        Sidebar.Size = UDim2.new(
            0,
            math.clamp(viewport.X * 0.22, 72, 105),
            1,
            0
        )
        ...
        PageContainer.Position =
            UDim2.new(
                0,
                math.clamp(viewport.X * 0.22, 72, 105) + 12,
                0,
                0
            )
        ...
        PageContainer.Size =
            UDim2.new(
                1,
                -(math.clamp(viewport.X * 0.22, 72, 105) + 17),
                1,
                0
            )
